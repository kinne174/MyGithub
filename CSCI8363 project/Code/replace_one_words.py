...
#function to replace words that appear one time in entire dataset with 'UNKNOWN_WORD' since no information can be used
#if in training and no information will be available if in testing
